...
public class HerderRequestHandler {
    ...
    private final AbstractConfig serverConfig;

    private long requestTimeoutMs;

    public HerderRequestHandler(AbstractConfig serverConfig, long requestTimeoutMs) {
        ...
        try {
            ...
            if (cause instanceof RequestTargetException) {
                if (forward == null || forward) {
                    ...
                    return translator.translate(RestClient.httpRequest(forwardUrl, method, headers, body, resultType, serverConfig));
                } else {
