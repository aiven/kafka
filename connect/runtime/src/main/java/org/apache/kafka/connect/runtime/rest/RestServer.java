...
public abstract class RestServer {
    ...
    protected final void initializeResources() {
        ...
        if (!Utils.isBlank(headerConfig)) {
            configureHttpResponsHeaderFilter(context, headerConfig);
        }
     ...
     */
    protected void configureHttpResponsHeaderFilter(ServletContextHandler context, String headerConfig) {
