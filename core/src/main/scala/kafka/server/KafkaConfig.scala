...
import org.apache.kafka.server.config.{AbstractKafkaConfig, MirrorConfig, KRaftConfigs, QuotaConfig, ReplicationConfigs, ServerConfigs, ServerLogConfigs}
...
class KafkaConfig private(doLog: Boolean, val props: util.Map[_, _])
  ...
  private val _mirrorConfig = new MirrorConfig(this)
  def mirrorConfig: MirrorConfig = _mirrorConfig
